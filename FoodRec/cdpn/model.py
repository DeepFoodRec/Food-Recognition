...
class CDPN(SegmentationModel):
    ...
    Args:
        ...
        decoder_pyramid_channels: a number of convolution filters in Feature Pyramid .
        decoder_segmentation_channels: a number of convolution filters in segmentation head.
    ...
    def __init__(
        ...
        #print("Encoder shape",self.encoder.out_channels.shape)
        #print("Encoder out_channels",self.encoder.out_channels)

        self.decoder = CDPNDecoder(
